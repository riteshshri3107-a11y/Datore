  ...
  return (
    <div className="space-y-3 animate-fade-in">
      ...
      <div className="flex items-center gap-2 rounded-xl px-3 py-2" style={{background:t.card,border:`1px solid ${t.cardBorder}`}}>
        ...
        <button onClick={voiceS} className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0" style={{background:voiceSrch?'rgba(239,68,68,0.1)':'rgba(247,151,22,0.08)'}}><IcoMic size={14} color={voiceSrch?'#ef4444':'#f97316'}/></button>
      </div>

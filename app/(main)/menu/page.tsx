...
const MENU = [
  ...
  { section: 'Activity', items: [
    { icon: '💼', label: 'My Jobs', path: '/jobplace' },
    { icon: '📦', label: 'My Listings', path: '/marketplace/my-listings' },
    { icon: '💾', label: 'Saved / Favorites', path: '/saved' },
    { icon: '👥', label: 'Buddy List', path: '/buddylist' },
  ]},
  { section: 'Discover', items: [
    { icon: '🗺️', label: 'Map View', path: '/jobplace/map' },
    { icon: '👷', label: 'Find Workers', path: '/jobplace/providers' },
    { icon: '🏪', label: 'Marketplace', path: '/marketplace' },
    { icon: '👥', label: 'Community', path: '/community' },
  ]},
  { section: 'Support', items: [
    { icon: '🔔', label: 'Notifications', path: '/notifications' },
    { icon: '💬', label: 'Messages', path: '/inbox' },
